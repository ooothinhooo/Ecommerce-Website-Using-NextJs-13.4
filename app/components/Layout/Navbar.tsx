    ...
    <div className='flex items-center justify-between py-4 relative'>
        ...
        <div className='flex items-center space-x-4'>
            ...
            <div onClick={() => setShowProfile(!showProfile)} className='relative cursor-pointer'>
                <img src="https://scontent.fvca1-4.fna.fbcdn.net/v/t39.30808-6/321114138_6581384388545058_1605283413299041475_n.jpg?stp=cp6_dst-jpg&_nc_cat=108&ccb=1-7&_nc_sid=dd5e9f&_nc_ohc=be6uwSXZKPoAX_EbeT4&_nc_ht=scontent.fvca1-4.fna&oh=00_AfDIKKKQ3sTJeqRg0aybj6J2bM_bCOwtHy7AYVsWGpkboQ&oe=657F5FB2" className='w-[35px] h-[35px] rounded-full object-cover' alt="" />
